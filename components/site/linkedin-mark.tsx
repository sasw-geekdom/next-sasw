// The LinkedIn glyph. lucide-react dropped brand icons in v1, and this is the
// only third-party mark the public site needs — inlined rather than pulling in
// a whole brand-icon package for one path. Inherits `currentColor`.
